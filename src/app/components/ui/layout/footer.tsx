    ...
    const quickLinks = [
        {
            title: "Services",
            links: [
                { name: "Telehealth", href: "under-development" },
                { name: "AI Diagnostics", href: "under-development" },
                { name: "Personal Health Tracking", href: "under-development" }
            ]
        },
        {
            title: "Company",
            links: [
                ...
                { name: "Our Team", href: "under-development" },
        ...
        },
        {
            ...
            links: [
                ...
                { name: "Research", href: "under-development" },
                { name: "Patient Guide", href: "under-development" }
            ]
        }
    ];

    const socialLinks = [
        { icon: Twitter, href: "under-development", color: "text-blue-400" },
        { icon: Linkedin, href: "under-development", color: "text-blue-600" },
        { icon: Facebook, href: "under-development", color: "text-blue-700" },
        { icon: Instagram, href: "under-development", color: "text-pink-500" }
    ];

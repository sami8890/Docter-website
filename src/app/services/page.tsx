...
const HealthServices = () => {
  ...
  // Ensure window dimensions are only accessed on the client side
  useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#161616] to-[#1e1e1e] overflow-hidden text-white py-16 mt-12">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <Link href={`/services/${service.title.toLowerCase().replace(/\s+/g, "-")}`} className="group flex items-center text-white/80 hover:text-white transition-colors">
                Learn More
        ...
        {/* Call to Action */}
        <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.8 }} className="text-center mt-16">
          <Link href="/under-development" className="group inline-flex items-center bg-gradient-to-r from-blue-600 to-emerald-600 px-8 py-4 rounded-lg text-white font-semibold hover:scale-105 transition-transform">
